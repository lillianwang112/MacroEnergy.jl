...
- Added monolithic perfect-foresight Modeling to Generate Alternatives (MGA)
  with GenX-equivalent capacity and annual-generation searches, paired random
  directions, auditable outputs, and restoration of the original objective.
